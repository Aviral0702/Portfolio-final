...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Podexo",
      description: "Podexo is a web application that transforms your podcast episodes into well-crafted blog posts, making your content more accessible and engaging.",
    ...
    {
      title: "Chattos",
      description: "Chattos is a real-time scalable chat application that allows users to create chat rooms and chat with other users in real-time.",
